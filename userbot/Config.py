...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "darkbot")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/Harsh-78/Dark-Userbot"
        )
        ...
        EXTRA_darkbot = os.environ.get("EXTRA_darkbot", -1001221881562)
