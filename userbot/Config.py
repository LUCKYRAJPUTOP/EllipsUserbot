...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "ellipsbot")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/LuckyRajputOP/EllipsUserbot"
        )
        ...
        EXTRA_ellipsbot = os.environ.get("EXTRA_Ellipsbot", -1001221881562)
