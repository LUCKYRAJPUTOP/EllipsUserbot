...
from darkbot.utils import admin_cmd, sudo_cmd, errors_handler
from userbot import bot as darkbot
from userbot import BOTLOG, BOTLOG_CHATID


@darkbot.on(admin_cmd(outgoing=True, pattern="del$"))
@darkbot.on(sudo_cmd(allow_sudo=True, pattern="del$"))
@errors_handler
