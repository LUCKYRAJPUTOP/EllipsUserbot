...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "Click [here](https://github.com/HARSH-78/DARK-USERBOT) to open this 🔥**Lit AF!!**🔥 __DARKBOT__ Repo.. Join channel :- @DARK_BOT_UPDATES")
...
async def smrk(smk):
    ...
    if message == "dele":
        await edit_or_reply(smk, message + "te the dark" + "ツ")
