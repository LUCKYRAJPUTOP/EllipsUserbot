...
from userbot import ALIVE_NAME, CUSTOM_PMPERMIT, dark_ID
...
darkPIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://telegra.ph/file/503a886dc82e9f5b233a8.jpg"
)
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
...
USER_BOT_NO_WARN = (
    "Hello, This is **Darkbot Ultra Private Security Protocol⚠️**.\n"
