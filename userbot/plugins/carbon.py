...
async def carbon_api(e):
    ...
    dark = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await dark.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await dark.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
...
async def carbon_api(e):
    if e.fwd_from:
        return
    dark = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
...
async def carbon_api(e):
    ...
    await dark.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await dark.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await dark.delete()  # Deleting msg
...
async def carbon_api(e):
    ...
    await dark.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await dark.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await dark.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await dark.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await dark.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await dark.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await dark.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await dark.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await dark.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await dark.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
